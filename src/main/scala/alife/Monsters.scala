...
object Monsters:
  ...
  private val _1: IndexedSeq[Instruction] = Vector(Cos(-1), Exp(-1), MyHealth, Const(0.09507841871622413),
  ...
  private val _2: IndexedSeq[Instruction] = Vector(Sin(-1), Const(0.1407119580029622), Const(0.10100863812199412), MyHealth,
  ...
  private val _3: IndexedSeq[Instruction] = Vector(MyHealth, EnergyAt(0), EnergyAt(1), Const(0.3701747306290796), MyHealth,
  ...
  val First: IndexedSeq[Instruction] = _3
